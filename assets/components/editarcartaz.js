...
const EditorCartaz = ({wrapperRef, containerRef, setZoom, usuario, setProdutoEditando, setVisivel, formatoEncarte, dadosencarte, zoom, templateAtivo, estiloencarte, watermark, paginarprodutos, setDadosEncarte}) => {
...
<div id="encarte-container"
 ref={containerRef}
className="cartaz" style={{...estiloencarte, transform: `translate(-50%, 0%) scale(${zoom})`}}>
            ...
            <div className="produtos">
              {paginarprodutos.map((produto, index) => {
                return (
                  ...
                  <h3 className="nome-produto">{produto.titulo}</h3>
